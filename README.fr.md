...
- [AI-math-lab](https://github.com/JulienDesdo/AI-math-lab) — lab de bases maths IA/ML — optimisation, SVM, entraînement MLP (Adam), et expériences Monte Carlo (avec rapports). 
